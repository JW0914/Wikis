...
Sub CreateSRP
	...
	sDesc = InputBox ("Please Type a Description for the Checkpoint", "Instant SR CheckPoint Creation","Instant SR Checkpoint")
	If Trim(sDesc) <> "" Then
		sOut = SRP.createrestorepoint (sDesc, 0, 100)
		If sOut <> 0 Then
	 		WScript.echo "Error " & sOut & ": Unable to create Restore Point."
                else 
                MsgBox "The restore point " & Chr(34) & sDesc & Chr(34) & " was created successfully.", 0, "SR Checkpoint"
		End If
	End If
End Sub
